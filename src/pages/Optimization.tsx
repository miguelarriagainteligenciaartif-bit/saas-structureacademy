...
export default function Optimization() {
  ...
  const [_slTrades, _setSlTrades] = useState<{ id: string; entry_model?: string; continuation_subtype?: string | null; entry_time?: string | null; fvg_count?: number | null; entry_subtype?: string | null }[]>([]);

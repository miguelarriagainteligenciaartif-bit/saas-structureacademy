  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    try {
      ...
      const insertData: any = {
        ...
        // Si es día sin entrada, dejar NULL los campos que solo tienen sentido con operación
        entry_time: values.no_trade_day ? null : (values.entry_time || "00:00:00"),
        exit_time: values.exit_time || null,
        trade_type: values.no_trade_day ? null : values.trade_type,
        result_type: values.no_trade_day ? null : values.result_type,
